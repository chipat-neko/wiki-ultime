...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/master-modes', label: 'Master Modes',       icon: Navigation,     isNew: true },
      { path: '/prison',       label: 'Prison & Klescher',  icon: AlertTriangle,  isNew: true },
      { path: '/signatures',   label: 'Signatures & Scan',  icon: Crosshair,      isNew: true },
      { path: '/missiles',     label: 'Missiles & CM',      icon: Target,         isNew: true },
      { path: '/bunkers',      label: 'Bunkers & Missions',  icon: Mountain,       isNew: true },
      { path: '/inventaire',          label: 'Inventaire & Objets',  icon: Package,        isNew: true },
      { path: '/vol-atmospherique',   label: 'Vol Atmosphérique',    icon: Navigation,     isNew: true },
      { path: '/contrebande',         label: 'Contrebande',          icon: AlertTriangle,  isNew: true },
      { path: '/epaves',              label: 'Épaves & Derelicts',   icon: Recycle,        isNew: true },
      { path: '/tourelles',           label: 'Guide Tourelles',      icon: Target,         isNew: true },
      { path: '/grottes',             label: 'Grottes & Minage FPS', icon: Gem,            isNew: true },
